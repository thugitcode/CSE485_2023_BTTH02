...
<body>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                <a href="views/author/add_author.php" class="btn btn-success">Thêm mới</a> <!-- Đã thay đổi đường dẫn -->
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="http://localhost:3000/index.php?controller=Author&action=delete" method="post" style="display:inline;">
                                            ...
                                            <button type="submit" class="btn btn-link" onclick="return confirm('Bạn có chắc chắn muốn xóa tác giả này không?');">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="text-center">Không có tác giả nào được tìm thấy.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
