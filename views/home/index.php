        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="http://localhost:3000/index.php?controller=Account&action=login">Đăng nhập</a>
                    </li>
                </ul>
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="../layout/detail.php" class="text-decoration-none">Cây, lá và gió</a>
                        </h5>
                    </div>
                </div>
            </div>
